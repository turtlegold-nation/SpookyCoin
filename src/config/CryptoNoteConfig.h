...
const uint64_t DIFFICULTY_TARGET                             = 80; // 60 --> 90 seconds recommended 
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(100); // 1
...
const uint64_t DATABASE_WRITE_BUFFER_MB_DEFAULT_SIZE         = 512; // 1 GB	
...
const uint16_t DATABASE_DEFAULT_BACKGROUND_THREADS_COUNT     = 4; // 5 DB threads
...
{
    {  0x24, 0x69, 0x6e, 0x73, 0x78, 0x28, 0x6c, 0x6c, 0x20, 0x67, 0x65, 0x6e, 0x74, 0x6f, 0x6f, 0x20  }
};

const char* const SEED_NODES[] = {
    "94.211.137.5:11420", // MunchieHigh420-Neeritter
    "84.30.12.206:11420", // MunchieHigh420-Stramproy
};
} // CryptoNote
